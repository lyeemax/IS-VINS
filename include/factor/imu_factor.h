  ...
  public:
    ...
    virtual bool Evaluate(double const *const *parameters, double *residuals, double **jacobians) const
    {
        ...
        if (jacobians)
        {
            ...
            {
                cerr<<"numerical unstable in preintegration"<<endl;
...
///                ROS_BREAK();
    ...
    void Evaluate(double const *PSi,double const *VBi,
                  double const *PSj,double const *VBj){
        ...
        Eigen::Vector3d Vj(VBj[0], VBj[1], VBj[2]);
        Eigen::Vector3d Baj(VBj[3], VBj[4], VBj[5]);
        Eigen::Vector3d Bgj(VBj[6], VBj[7], VBj[8]);
        ...
        {
            Eigen::Matrix<double, 15, 6> jacobian_pose_i;
            jacobian_pose_i.setZero();
        ...
        {
            Eigen::Matrix<double, 15, 6> jacobian_pose_j;
            jacobian_pose_j.setZero();
